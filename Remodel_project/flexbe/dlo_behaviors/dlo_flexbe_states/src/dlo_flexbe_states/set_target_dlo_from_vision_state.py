...
class SetTargetDloFromVision(EventState):
    def __init__(self, srv_name="/dlo_state_planner/set_target_dlo_state_from_vision"):
        super(SetTargetDloFromVision, self).__init__(outcomes=["done", "failed"])
