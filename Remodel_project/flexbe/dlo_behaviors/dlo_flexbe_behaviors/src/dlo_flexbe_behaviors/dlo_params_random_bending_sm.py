...
@author: xxx
'''
class dlo_params_random_bendingSM(Behavior):
	'''
	xxx
	'''
	...
	def __init__(self):
		super(dlo_params_random_bendingSM, self).__init__()
		self.name = 'dlo_params_random_bending'
	...
	def create(self):
		...
		_state_machine.userdata.max_range = 0.075
		_state_machine.userdata.min_range = 0.074999
		_state_machine.userdata.dtheta_range = 0.0
		_state_machine.userdata.prediction = []
